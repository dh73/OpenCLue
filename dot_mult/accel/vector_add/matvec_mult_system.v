...
(
   ...
   input logic clock2x,
   input logic resetn,
   // AVS avs_matvec_mult_cra
   input logic avs_matvec_mult_cra_enable,
   input logic avs_matvec_mult_cra_read,
   input logic avs_matvec_mult_cra_write,
   input logic [3:0] avs_matvec_mult_cra_address,
   input logic [63:0] avs_matvec_mult_cra_writedata,
   input logic [7:0] avs_matvec_mult_cra_byteenable,
   output logic [63:0] avs_matvec_mult_cra_readdata,
   output logic avs_matvec_mult_cra_readdatavalid,
   ...
   // INST matvec_mult_std_ic_inst of matvec_mult_std_ic_partition_wrapper
   matvec_mult_std_ic_partition_wrapper matvec_mult_std_ic_inst
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq_matvec_mult(kernel_irqs),
      // AVS avs_matvec_mult_cra
      .avs_matvec_mult_cra_enable(avs_matvec_mult_cra_enable),
      .avs_matvec_mult_cra_read(avs_matvec_mult_cra_read),
      .avs_matvec_mult_cra_write(avs_matvec_mult_cra_write),
      .avs_matvec_mult_cra_address(avs_matvec_mult_cra_address),
      .avs_matvec_mult_cra_writedata(avs_matvec_mult_cra_writedata),
      .avs_matvec_mult_cra_byteenable(avs_matvec_mult_cra_byteenable),
      .avs_matvec_mult_cra_readdata(avs_matvec_mult_cra_readdata),
      .avs_matvec_mult_cra_readdatavalid(avs_matvec_mult_cra_readdatavalid),
      // AVM matvec_mult_0_avm_unnamed_matvec_mult0
      .matvec_mult_0_avm_unnamed_matvec_mult0_enable(gmem0_global_avm_enable[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_read(gmem0_global_avm_read[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_write(gmem0_global_avm_write[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_burstcount(gmem0_global_avm_burstcount[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_address(gmem0_global_avm_address[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_writedata(gmem0_global_avm_writedata[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_byteenable(gmem0_global_avm_byteenable[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_waitrequest(gmem0_global_avm_waitrequest[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_readdata(gmem0_global_avm_readdata[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_readdatavalid(gmem0_global_avm_readdatavalid[0]),
      .matvec_mult_0_avm_unnamed_matvec_mult0_writeack(gmem0_global_avm_writeack[0]),
      // AVM matvec_mult_0_avm_unnamed_matvec_mult1
      .matvec_mult_0_avm_unnamed_matvec_mult1_enable(gmem0_global_avm_enable[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_read(gmem0_global_avm_read[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_write(gmem0_global_avm_write[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_burstcount(gmem0_global_avm_burstcount[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_address(gmem0_global_avm_address[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_writedata(gmem0_global_avm_writedata[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_byteenable(gmem0_global_avm_byteenable[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_waitrequest(gmem0_global_avm_waitrequest[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_readdata(gmem0_global_avm_readdata[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_readdatavalid(gmem0_global_avm_readdatavalid[1]),
      .matvec_mult_0_avm_unnamed_matvec_mult1_writeack(gmem0_global_avm_writeack[1]),
      // AVM matvec_mult_0_avm_unnamed_matvec_mult2
      .matvec_mult_0_avm_unnamed_matvec_mult2_enable(gmem0_global_avm_enable[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_read(gmem0_global_avm_read[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_write(gmem0_global_avm_write[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_burstcount(gmem0_global_avm_burstcount[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_address(gmem0_global_avm_address[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_writedata(gmem0_global_avm_writedata[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_byteenable(gmem0_global_avm_byteenable[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_waitrequest(gmem0_global_avm_waitrequest[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_readdata(gmem0_global_avm_readdata[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_readdatavalid(gmem0_global_avm_readdatavalid[2]),
      .matvec_mult_0_avm_unnamed_matvec_mult2_writeack(gmem0_global_avm_writeack[2])
   );
...
/////////////////////////////////////////////////////////////////
// MODULE matvec_mult_std_ic_partition_wrapper
/////////////////////////////////////////////////////////////////
module matvec_mult_std_ic_partition_wrapper
(
   input logic clock,
   input logic clock2x,
   input logic resetn,
   output logic cra_irq_matvec_mult,
   // AVS avs_matvec_mult_cra
   input logic avs_matvec_mult_cra_enable,
   input logic avs_matvec_mult_cra_read,
   input logic avs_matvec_mult_cra_write,
   ...
   output logic avs_matvec_mult_cra_readdatavalid,
   // AVM matvec_mult_0_avm_unnamed_matvec_mult0
   output logic matvec_mult_0_avm_unnamed_matvec_mult0_enable,
   output logic matvec_mult_0_avm_unnamed_matvec_mult0_read,
   output logic matvec_mult_0_avm_unnamed_matvec_mult0_write,
   output logic [4:0] matvec_mult_0_avm_unnamed_matvec_mult0_burstcount,
   output logic [29:0] matvec_mult_0_avm_unnamed_matvec_mult0_address,
   output logic [255:0] matvec_mult_0_avm_unnamed_matvec_mult0_writedata,
   output logic [31:0] matvec_mult_0_avm_unnamed_matvec_mult0_byteenable,
   input logic matvec_mult_0_avm_unnamed_matvec_mult0_waitrequest,
   input logic [255:0] matvec_mult_0_avm_unnamed_matvec_mult0_readdata,
   input logic matvec_mult_0_avm_unnamed_matvec_mult0_readdatavalid,
   input logic matvec_mult_0_avm_unnamed_matvec_mult0_writeack,
   // AVM matvec_mult_0_avm_unnamed_matvec_mult1
   output logic matvec_mult_0_avm_unnamed_matvec_mult1_enable,
   output logic matvec_mult_0_avm_unnamed_matvec_mult1_read,
   output logic matvec_mult_0_avm_unnamed_matvec_mult1_write,
   output logic [4:0] matvec_mult_0_avm_unnamed_matvec_mult1_burstcount,
   output logic [29:0] matvec_mult_0_avm_unnamed_matvec_mult1_address,
   output logic [255:0] matvec_mult_0_avm_unnamed_matvec_mult1_writedata,
   output logic [31:0] matvec_mult_0_avm_unnamed_matvec_mult1_byteenable,
   input logic matvec_mult_0_avm_unnamed_matvec_mult1_waitrequest,
   input logic [255:0] matvec_mult_0_avm_unnamed_matvec_mult1_readdata,
   input logic matvec_mult_0_avm_unnamed_matvec_mult1_readdatavalid,
   input logic matvec_mult_0_avm_unnamed_matvec_mult1_writeack,
   // AVM matvec_mult_0_avm_unnamed_matvec_mult2
   output logic matvec_mult_0_avm_unnamed_matvec_mult2_enable,
   output logic matvec_mult_0_avm_unnamed_matvec_mult2_read,
   output logic matvec_mult_0_avm_unnamed_matvec_mult2_write,
   output logic [4:0] matvec_mult_0_avm_unnamed_matvec_mult2_burstcount,
   output logic [29:0] matvec_mult_0_avm_unnamed_matvec_mult2_address,
   output logic [255:0] matvec_mult_0_avm_unnamed_matvec_mult2_writedata,
   output logic [31:0] matvec_mult_0_avm_unnamed_matvec_mult2_byteenable,
   input logic matvec_mult_0_avm_unnamed_matvec_mult2_waitrequest,
   input logic [255:0] matvec_mult_0_avm_unnamed_matvec_mult2_readdata,
   input logic matvec_mult_0_avm_unnamed_matvec_mult2_readdatavalid,
   input logic matvec_mult_0_avm_unnamed_matvec_mult2_writeack
);
   logic matvec_mult_start;
   logic [0:0] matvec_mult_start_chain;
   logic [0:0] matvec_mult_start_kernel_copy;
   logic [0:0] matvec_mult_start_task_fd;
   logic [0:0] matvec_mult_start_finish_element;
   logic matvec_mult_finish;
   logic [0:0] matvec_mult_finish_kernel_copy;
   logic [0:0] matvec_mult_finish_chain;
   logic [31:0] matvec_mult_global_size [2:0];
   logic [31:0] matvec_mult_num_groups [2:0];
   logic [31:0] matvec_mult_local_size [2:0];
   logic [31:0] matvec_mult_global_offset [2:0];
   logic [31:0] matvec_mult_work_dim;
   logic [31:0] matvec_mult_wg_size;
   logic [0:0] matvec_mult_wg_disp_stall_in;
   logic [0:0] matvec_mult_wg_disp_stall_in_lookahead;
   logic [0:0] matvec_mult_wg_disp_valid_out;
   logic matvec_mult_wg_disp_start_out;
   logic [31:0] matvec_mult_wg_disp_group_id_out [2:0];
   logic [31:0] matvec_mult_wg_disp_global_id_base_out [2:0];
   logic matvec_mult_wg_disp_dispatched_all_groups;
   logic [31:0] matvec_mult_global_id [1][2:0];
   logic [31:0] matvec_mult_local_id [1][2:0];
   logic [31:0] matvec_mult_group_id [1][2:0];
   logic [0:0] matvec_mult_pending_write;
   logic [0:0] matvec_mult_lsu_active;
   logic [0:0] matvec_mult_valid_in;
   logic [0:0] matvec_mult_valid_out;
   logic [0:0] matvec_mult_stall_in;
   logic [0:0] matvec_mult_stall_out;
   logic matvec_mult_cra_pending_write;
   logic matvec_mult_cra_lsu_active;
   logic matvec_mult_cra_valid_in;
   logic [191:0] matvec_mult_kernel_arguments;

   assign matvec_mult_start_chain[0] = matvec_mult_start;
   assign matvec_mult_finish_chain[0] = 1'b1;
   assign matvec_mult_cra_pending_write = |matvec_mult_pending_write;
   assign matvec_mult_cra_lsu_active = |matvec_mult_lsu_active;
   assign matvec_mult_cra_valid_in = |matvec_mult_valid_in;
   assign matvec_mult_stall_in = 0;
   // INST matvec_mult_workgroup_dispatcher of acl_work_group_dispatcher
   ...
   matvec_mult_workgroup_dispatcher
   (
      .clock(clock),
      .resetn(resetn),
      .start(matvec_mult_start),
      .num_groups(matvec_mult_num_groups),
      .local_size(matvec_mult_local_size),
      .stall_in(matvec_mult_wg_disp_stall_in),
      .stall_in_lookahead(matvec_mult_wg_disp_stall_in_lookahead),
      .valid_out(matvec_mult_wg_disp_valid_out),
      .group_id_out(matvec_mult_wg_disp_group_id_out),
      .global_id_base_out(matvec_mult_wg_disp_global_id_base_out),
      .start_out(matvec_mult_wg_disp_start_out),
      .dispatched_all_groups(matvec_mult_wg_disp_dispatched_all_groups)
   );

   // INST matvec_mult_finish_detector of acl_kernel_finish_detector
   ...
   matvec_mult_finish_detector
   (
      .clock(clock),
      .resetn(resetn),
      .start(matvec_mult_start),
      .wg_size(matvec_mult_wg_size),
      .wg_dispatch_valid_out(matvec_mult_wg_disp_valid_out),
      .wg_dispatch_stall_in(matvec_mult_wg_disp_stall_in),
      .dispatched_all_groups(matvec_mult_wg_disp_dispatched_all_groups),
      .kernel_copy_valid_out(matvec_mult_valid_out),
      .kernel_copy_stall_in(matvec_mult_stall_in),
      .pending_writes(matvec_mult_cra_pending_write),
      .finish(matvec_mult_finish)
   );

   // INST matvec_mult_cra_slave_inst of matvec_mult_function_cra_slave
   matvec_mult_function_cra_slave matvec_mult_cra_slave_inst
   (
      .clock(clock),
      .resetn(resetn),
      .start(matvec_mult_start),
      .finish(matvec_mult_finish),
      .global_offset_0(matvec_mult_global_offset[0]),
      .global_offset_1(matvec_mult_global_offset[1]),
      .global_offset_2(matvec_mult_global_offset[2]),
      .work_dim(matvec_mult_work_dim),
      .has_a_lsu_active(matvec_mult_cra_lsu_active),
      .has_a_write_pending(matvec_mult_cra_pending_write),
      .valid_in(matvec_mult_cra_valid_in),
      .global_size_0(matvec_mult_global_size[0]),
      .global_size_1(matvec_mult_global_size[1]),
      .global_size_2(matvec_mult_global_size[2]),
      .num_groups_0(matvec_mult_num_groups[0]),
      .num_groups_1(matvec_mult_num_groups[1]),
      .num_groups_2(matvec_mult_num_groups[2]),
      .local_size_0(matvec_mult_local_size[0]),
      .local_size_1(matvec_mult_local_size[1]),
      .local_size_2(matvec_mult_local_size[2]),
      .workgroup_size(matvec_mult_wg_size),
      .kernel_arguments(matvec_mult_kernel_arguments),
      .cra_irq(cra_irq_matvec_mult),
      // AVS avs_cra
      .avs_cra_enable(avs_matvec_mult_cra_enable),
      .avs_cra_read(avs_matvec_mult_cra_read),
      .avs_cra_write(avs_matvec_mult_cra_write),
      .avs_cra_address(avs_matvec_mult_cra_address),
      .avs_cra_writedata(avs_matvec_mult_cra_writedata),
      .avs_cra_byteenable(avs_matvec_mult_cra_byteenable),
      .avs_cra_readdata(avs_matvec_mult_cra_readdata),
      .avs_cra_readdatavalid(avs_matvec_mult_cra_readdatavalid)
   );

   // INST matvec_mult_id_iter_inst_0 of acl_id_iterator
   acl_id_iterator
   #(
      .WIDTH(32),
      .LOCAL_WIDTH_X(32),
   ...
   matvec_mult_id_iter_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start(matvec_mult_wg_disp_start_out),
      .valid_in(matvec_mult_wg_disp_valid_out[0]),
      .stall_out(matvec_mult_wg_disp_stall_in[0]),
      .stall_out_lookahead(matvec_mult_wg_disp_stall_in_lookahead[0]),
      .stall_in(matvec_mult_stall_out[0]),
      .valid_out(matvec_mult_valid_in[0]),
      .group_id_in(matvec_mult_wg_disp_group_id_out),
      .global_id_base_in(matvec_mult_wg_disp_global_id_base_out),
      .local_size(matvec_mult_local_size),
      .global_size(matvec_mult_global_size),
      .local_id(matvec_mult_local_id[0]),
      .global_id(matvec_mult_global_id[0]),
      .group_id(matvec_mult_group_id[0])
   );

   // INST matvec_mult_inst_0 of matvec_mult_top_wrapper_0
   matvec_mult_top_wrapper_0 matvec_mult_inst_0
   (
      .start(matvec_mult_start_kernel_copy[0]),
      .kernel_arguments(matvec_mult_kernel_arguments),
      .work_dim(matvec_mult_work_dim),
      .global_offset(matvec_mult_global_offset),
      .kernel_valid_out(matvec_mult_valid_out[0]),
      .has_a_write_pending(matvec_mult_pending_write[0]),
      .has_a_lsu_active(matvec_mult_lsu_active[0]),
      .global_id(matvec_mult_global_id[0]),
      .local_id(matvec_mult_local_id[0]),
      .group_id(matvec_mult_group_id[0]),
      .global_size(matvec_mult_global_size),
      ...
      .num_groups(matvec_mult_num_groups),
      .workgroup_size(matvec_mult_wg_size),
      .kernel_stall_out(matvec_mult_stall_out[0]),
      .kernel_valid_in(matvec_mult_valid_in[0]),
      .clock(clock),
      .resetn(resetn),
      .clock2x(clock2x),
      // AVM avm_unnamed_matvec_mult0
      .avm_unnamed_matvec_mult0_enable(matvec_mult_0_avm_unnamed_matvec_mult0_enable),
      .avm_unnamed_matvec_mult0_read(matvec_mult_0_avm_unnamed_matvec_mult0_read),
      .avm_unnamed_matvec_mult0_write(matvec_mult_0_avm_unnamed_matvec_mult0_write),
      .avm_unnamed_matvec_mult0_burstcount(matvec_mult_0_avm_unnamed_matvec_mult0_burstcount),
      .avm_unnamed_matvec_mult0_address(matvec_mult_0_avm_unnamed_matvec_mult0_address),
      .avm_unnamed_matvec_mult0_writedata(matvec_mult_0_avm_unnamed_matvec_mult0_writedata),
      .avm_unnamed_matvec_mult0_byteenable(matvec_mult_0_avm_unnamed_matvec_mult0_byteenable),
      .avm_unnamed_matvec_mult0_waitrequest(matvec_mult_0_avm_unnamed_matvec_mult0_waitrequest),
      .avm_unnamed_matvec_mult0_readdata(matvec_mult_0_avm_unnamed_matvec_mult0_readdata),
      .avm_unnamed_matvec_mult0_readdatavalid(matvec_mult_0_avm_unnamed_matvec_mult0_readdatavalid),
      .avm_unnamed_matvec_mult0_writeack(matvec_mult_0_avm_unnamed_matvec_mult0_writeack),
      // AVM avm_unnamed_matvec_mult1
      .avm_unnamed_matvec_mult1_enable(matvec_mult_0_avm_unnamed_matvec_mult1_enable),
      .avm_unnamed_matvec_mult1_read(matvec_mult_0_avm_unnamed_matvec_mult1_read),
      .avm_unnamed_matvec_mult1_write(matvec_mult_0_avm_unnamed_matvec_mult1_write),
      .avm_unnamed_matvec_mult1_burstcount(matvec_mult_0_avm_unnamed_matvec_mult1_burstcount),
      .avm_unnamed_matvec_mult1_address(matvec_mult_0_avm_unnamed_matvec_mult1_address),
      .avm_unnamed_matvec_mult1_writedata(matvec_mult_0_avm_unnamed_matvec_mult1_writedata),
      .avm_unnamed_matvec_mult1_byteenable(matvec_mult_0_avm_unnamed_matvec_mult1_byteenable),
      .avm_unnamed_matvec_mult1_waitrequest(matvec_mult_0_avm_unnamed_matvec_mult1_waitrequest),
      .avm_unnamed_matvec_mult1_readdata(matvec_mult_0_avm_unnamed_matvec_mult1_readdata),
      .avm_unnamed_matvec_mult1_readdatavalid(matvec_mult_0_avm_unnamed_matvec_mult1_readdatavalid),
      .avm_unnamed_matvec_mult1_writeack(matvec_mult_0_avm_unnamed_matvec_mult1_writeack),
      // AVM avm_unnamed_matvec_mult2
      .avm_unnamed_matvec_mult2_enable(matvec_mult_0_avm_unnamed_matvec_mult2_enable),
      .avm_unnamed_matvec_mult2_read(matvec_mult_0_avm_unnamed_matvec_mult2_read),
      .avm_unnamed_matvec_mult2_write(matvec_mult_0_avm_unnamed_matvec_mult2_write),
      .avm_unnamed_matvec_mult2_burstcount(matvec_mult_0_avm_unnamed_matvec_mult2_burstcount),
      .avm_unnamed_matvec_mult2_address(matvec_mult_0_avm_unnamed_matvec_mult2_address),
      .avm_unnamed_matvec_mult2_writedata(matvec_mult_0_avm_unnamed_matvec_mult2_writedata),
      .avm_unnamed_matvec_mult2_byteenable(matvec_mult_0_avm_unnamed_matvec_mult2_byteenable),
      .avm_unnamed_matvec_mult2_waitrequest(matvec_mult_0_avm_unnamed_matvec_mult2_waitrequest),
      .avm_unnamed_matvec_mult2_readdata(matvec_mult_0_avm_unnamed_matvec_mult2_readdata),
      .avm_unnamed_matvec_mult2_readdatavalid(matvec_mult_0_avm_unnamed_matvec_mult2_readdatavalid),
      .avm_unnamed_matvec_mult2_writeack(matvec_mult_0_avm_unnamed_matvec_mult2_writeack)
   );

   // INST matvec_mult_start_elem_inst_0 of acl_start_signal_chain_element
   acl_start_signal_chain_element
   #(
      .ASYNC_RESET(1),
      .SYNCHRONIZE_RESET(0)
   )
   matvec_mult_start_elem_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start_in(matvec_mult_start_chain[0]),
      .start_kernel(matvec_mult_start_kernel_copy[0]),
      .start_finish_detector(matvec_mult_start_task_fd[0]),
      .start_finish_chain_element(matvec_mult_start_finish_element[0]),
      .start_chain()
   );
...
/////////////////////////////////////////////////////////////////
// MODULE matvec_mult_top_wrapper_0
/////////////////////////////////////////////////////////////////
module matvec_mult_top_wrapper_0
(
   input logic start,
   ...
   input logic clock2x,
   // AVM avm_unnamed_matvec_mult0
   output logic avm_unnamed_matvec_mult0_enable,
   output logic avm_unnamed_matvec_mult0_read,
   output logic avm_unnamed_matvec_mult0_write,
   output logic [4:0] avm_unnamed_matvec_mult0_burstcount,
   output logic [29:0] avm_unnamed_matvec_mult0_address,
   output logic [255:0] avm_unnamed_matvec_mult0_writedata,
   output logic [31:0] avm_unnamed_matvec_mult0_byteenable,
   input logic avm_unnamed_matvec_mult0_waitrequest,
   input logic [255:0] avm_unnamed_matvec_mult0_readdata,
   input logic avm_unnamed_matvec_mult0_readdatavalid,
   input logic avm_unnamed_matvec_mult0_writeack,
   // AVM avm_unnamed_matvec_mult1
   output logic avm_unnamed_matvec_mult1_enable,
   output logic avm_unnamed_matvec_mult1_read,
   output logic avm_unnamed_matvec_mult1_write,
   output logic [4:0] avm_unnamed_matvec_mult1_burstcount,
   output logic [29:0] avm_unnamed_matvec_mult1_address,
   output logic [255:0] avm_unnamed_matvec_mult1_writedata,
   output logic [31:0] avm_unnamed_matvec_mult1_byteenable,
   input logic avm_unnamed_matvec_mult1_waitrequest,
   input logic [255:0] avm_unnamed_matvec_mult1_readdata,
   input logic avm_unnamed_matvec_mult1_readdatavalid,
   input logic avm_unnamed_matvec_mult1_writeack,
   // AVM avm_unnamed_matvec_mult2
   output logic avm_unnamed_matvec_mult2_enable,
   output logic avm_unnamed_matvec_mult2_read,
   output logic avm_unnamed_matvec_mult2_write,
   output logic [4:0] avm_unnamed_matvec_mult2_burstcount,
   output logic [29:0] avm_unnamed_matvec_mult2_address,
   output logic [255:0] avm_unnamed_matvec_mult2_writedata,
   output logic [31:0] avm_unnamed_matvec_mult2_byteenable,
   input logic avm_unnamed_matvec_mult2_waitrequest,
   input logic [255:0] avm_unnamed_matvec_mult2_readdata,
   input logic avm_unnamed_matvec_mult2_readdatavalid,
   input logic avm_unnamed_matvec_mult2_writeack
);
   logic lmem_invalid_single_bit;

   // INST kernel of matvec_mult_function_wrapper
   matvec_mult_function_wrapper kernel
   (
      ...
      .clock2x(clock2x),
      // AVM avm_unnamed_matvec_mult0
      .avm_unnamed_matvec_mult0_enable(avm_unnamed_matvec_mult0_enable),
      .avm_unnamed_matvec_mult0_read(avm_unnamed_matvec_mult0_read),
      .avm_unnamed_matvec_mult0_write(avm_unnamed_matvec_mult0_write),
      .avm_unnamed_matvec_mult0_burstcount(avm_unnamed_matvec_mult0_burstcount),
      .avm_unnamed_matvec_mult0_address(avm_unnamed_matvec_mult0_address),
      .avm_unnamed_matvec_mult0_writedata(avm_unnamed_matvec_mult0_writedata),
      .avm_unnamed_matvec_mult0_byteenable(avm_unnamed_matvec_mult0_byteenable),
      .avm_unnamed_matvec_mult0_waitrequest(avm_unnamed_matvec_mult0_waitrequest),
      .avm_unnamed_matvec_mult0_readdata(avm_unnamed_matvec_mult0_readdata),
      .avm_unnamed_matvec_mult0_readdatavalid(avm_unnamed_matvec_mult0_readdatavalid),
      .avm_unnamed_matvec_mult0_writeack(avm_unnamed_matvec_mult0_writeack),
      // AVM avm_unnamed_matvec_mult1
      .avm_unnamed_matvec_mult1_enable(avm_unnamed_matvec_mult1_enable),
      .avm_unnamed_matvec_mult1_read(avm_unnamed_matvec_mult1_read),
      .avm_unnamed_matvec_mult1_write(avm_unnamed_matvec_mult1_write),
      .avm_unnamed_matvec_mult1_burstcount(avm_unnamed_matvec_mult1_burstcount),
      .avm_unnamed_matvec_mult1_address(avm_unnamed_matvec_mult1_address),
      .avm_unnamed_matvec_mult1_writedata(avm_unnamed_matvec_mult1_writedata),
      .avm_unnamed_matvec_mult1_byteenable(avm_unnamed_matvec_mult1_byteenable),
      .avm_unnamed_matvec_mult1_waitrequest(avm_unnamed_matvec_mult1_waitrequest),
      .avm_unnamed_matvec_mult1_readdata(avm_unnamed_matvec_mult1_readdata),
      .avm_unnamed_matvec_mult1_readdatavalid(avm_unnamed_matvec_mult1_readdatavalid),
      .avm_unnamed_matvec_mult1_writeack(avm_unnamed_matvec_mult1_writeack),
      // AVM avm_unnamed_matvec_mult2
      .avm_unnamed_matvec_mult2_enable(avm_unnamed_matvec_mult2_enable),
      .avm_unnamed_matvec_mult2_read(avm_unnamed_matvec_mult2_read),
      .avm_unnamed_matvec_mult2_write(avm_unnamed_matvec_mult2_write),
      .avm_unnamed_matvec_mult2_burstcount(avm_unnamed_matvec_mult2_burstcount),
      .avm_unnamed_matvec_mult2_address(avm_unnamed_matvec_mult2_address),
      .avm_unnamed_matvec_mult2_writedata(avm_unnamed_matvec_mult2_writedata),
      .avm_unnamed_matvec_mult2_byteenable(avm_unnamed_matvec_mult2_byteenable),
      .avm_unnamed_matvec_mult2_waitrequest(avm_unnamed_matvec_mult2_waitrequest),
      .avm_unnamed_matvec_mult2_readdata(avm_unnamed_matvec_mult2_readdata),
      .avm_unnamed_matvec_mult2_readdatavalid(avm_unnamed_matvec_mult2_readdatavalid),
      .avm_unnamed_matvec_mult2_writeack(avm_unnamed_matvec_mult2_writeack)
   );
...
(
   ...
   begin:gmem0_
      ...
      // INST global_ic_preroutegmem0_router_0 of matvec_mult_system_interconnect_0
      matvec_mult_system_interconnect_0 global_ic_preroutegmem0_router_0
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_router_1 of matvec_mult_system_interconnect_1
      matvec_mult_system_interconnect_1 global_ic_preroutegmem0_router_1
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_router_2 of matvec_mult_system_interconnect_1
      matvec_mult_system_interconnect_1 global_ic_preroutegmem0_router_2
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_icgmem0_port_0_0_rw of matvec_mult_system_interconnect_2
      matvec_mult_system_interconnect_2 global_icgmem0_port_0_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE matvec_mult_system_interconnect_0
/////////////////////////////////////////////////////////////////
module matvec_mult_system_interconnect_0
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE matvec_mult_system_interconnect_1
/////////////////////////////////////////////////////////////////
module matvec_mult_system_interconnect_1
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE matvec_mult_system_interconnect_2
/////////////////////////////////////////////////////////////////
module matvec_mult_system_interconnect_2
(
   input logic clock,
