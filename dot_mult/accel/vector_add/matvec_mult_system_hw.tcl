...
set_module_property NAME matvec_mult_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME matvec_mult_system
...
#### Slave interface avs_matvec_mult_cra
add_interface avs_matvec_mult_cra avalon end
set_interface_property avs_matvec_mult_cra ENABLED true
set_interface_property avs_matvec_mult_cra associatedClock clock_reset
set_interface_property avs_matvec_mult_cra addressAlignment DYNAMIC
set_interface_property avs_matvec_mult_cra burstOnBurstBoundariesOnly false
set_interface_property avs_matvec_mult_cra explicitAddressSpan 0
set_interface_property avs_matvec_mult_cra holdTime 0
set_interface_property avs_matvec_mult_cra isMemoryDevice false
set_interface_property avs_matvec_mult_cra isNonVolatileStorage false
set_interface_property avs_matvec_mult_cra linewrapBursts false
set_interface_property avs_matvec_mult_cra maximumPendingReadTransactions 1
set_interface_property avs_matvec_mult_cra printableDevice false
set_interface_property avs_matvec_mult_cra readLatency 0
set_interface_property avs_matvec_mult_cra readWaitTime 0
set_interface_property avs_matvec_mult_cra setupTime 0
set_interface_property avs_matvec_mult_cra timingUnits Cycles
set_interface_property avs_matvec_mult_cra writeWaitTime 0
set_interface_assignment avs_matvec_mult_cra hls.cosim.name {}
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_read read input 1
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_write write input 1
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_address address input 4
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_writedata writedata input 64
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_byteenable byteenable input 8
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_readdata readdata output 64
add_interface_port avs_matvec_mult_cra avs_matvec_mult_cra_readdatavalid readdatavalid output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL matvec_mult_system
...
add_fileset_file matvec_mult_system.v SYSTEM_VERILOG PATH matvec_mult_system.v TOP_LEVEL_FILE
...
add_fileset_file matvec_mult_function_wrapper.vhd VHDL PATH kernel_hdl/matvec_mult/matvec_mult_function_wrapper.vhd TOP_LEVEL_FILE
add_fileset_file matvec_mult_function.vhd VHDL PATH kernel_hdl/matvec_mult/matvec_mult_function.vhd TOP_LEVEL_FILE
add_fileset_file bb_matvec_mult_B0.vhd VHDL PATH kernel_hdl/matvec_mult/bb_matvec_mult_B0.vhd TOP_LEVEL_FILE
add_fileset_file bb_matvec_mult_B0_stall_region.vhd VHDL PATH kernel_hdl/matvec_mult/bb_matvec_mult_B0_stall_region.vhd TOP_LEVEL_FILE
add_fileset_file i_sfc_c0_entry_matvec_mult_c0_enter_matvec_mult.vhd VHDL PATH kernel_hdl/matvec_mult/i_sfc_c0_entry_matvec_mult_c0_enter_matvec_mult.vhd TOP_LEVEL_FILE
add_fileset_file i_acl_sfc_exit_c0_entry_matvec_mult_c0_eA0Zit_matvec_mult14.vhd VHDL PATH kernel_hdl/matvec_mult/i_acl_sfc_exit_c0_entry_matvec_mult_c0_eA0Zit_matvec_mult14.vhd TOP_LEVEL_FILE
add_fileset_file i_acl_sfc_exit_c0_entry_matvec_mult_c0_eA0Zmult17_data_fifo.vhd VHDL PATH kernel_hdl/matvec_mult/i_acl_sfc_exit_c0_entry_matvec_mult_c0_eA0Zmult17_data_fifo.vhd TOP_LEVEL_FILE
add_fileset_file i_acl_sfc_exit_c0_entry_matvec_mult_c0_eA0Zlt_full_detector.vhd VHDL PATH kernel_hdl/matvec_mult/i_acl_sfc_exit_c0_entry_matvec_mult_c0_eA0Zlt_full_detector.vhd TOP_LEVEL_FILE
add_fileset_file i_sfc_logic_c0_entry_matvec_mult_c0_enter_matvec_mult12.vhd VHDL PATH kernel_hdl/matvec_mult/i_sfc_logic_c0_entry_matvec_mult_c0_enter_matvec_mult12.vhd TOP_LEVEL_FILE
add_fileset_file floatComponent_i_sfc_logic_c0_entry_matvA0Zcd0oq3cd06oq3cz0.vhd VHDL PATH kernel_hdl/matvec_mult/floatComponent_i_sfc_logic_c0_entry_matvA0Zcd0oq3cd06oq3cz0.vhd TOP_LEVEL_FILE
add_fileset_file floatComponent_i_sfc_logic_c0_entry_matvA0Z0cp36cd0oq3cdj6z.vhd VHDL PATH kernel_hdl/matvec_mult/floatComponent_i_sfc_logic_c0_entry_matvA0Z0cp36cd0oq3cdj6z.vhd TOP_LEVEL_FILE
add_fileset_file i_load_unnamed_matvec_mult0_matvec_mult7.vhd VHDL PATH kernel_hdl/matvec_mult/i_load_unnamed_matvec_mult0_matvec_mult7.vhd TOP_LEVEL_FILE
add_fileset_file readdata_reg_unnamed_matvec_mult0_matvec_mult0.vhd VHDL PATH kernel_hdl/matvec_mult/readdata_reg_unnamed_matvec_mult0_matvec_mult0.vhd TOP_LEVEL_FILE
add_fileset_file i_load_unnamed_matvec_mult1_matvec_mult10.vhd VHDL PATH kernel_hdl/matvec_mult/i_load_unnamed_matvec_mult1_matvec_mult10.vhd TOP_LEVEL_FILE
add_fileset_file readdata_reg_unnamed_matvec_mult1_matvec_mult1.vhd VHDL PATH kernel_hdl/matvec_mult/readdata_reg_unnamed_matvec_mult1_matvec_mult1.vhd TOP_LEVEL_FILE
add_fileset_file i_store_unnamed_matvec_mult2_matvec_mult15.vhd VHDL PATH kernel_hdl/matvec_mult/i_store_unnamed_matvec_mult2_matvec_mult15.vhd TOP_LEVEL_FILE
add_fileset_file matvec_mult_B0_merge_reg.vhd VHDL PATH kernel_hdl/matvec_mult/matvec_mult_B0_merge_reg.vhd TOP_LEVEL_FILE
add_fileset_file i_syncbuf_dot_sync_buffer_matvec_mult2.vhd VHDL PATH kernel_hdl/matvec_mult/i_syncbuf_dot_sync_buffer_matvec_mult2.vhd TOP_LEVEL_FILE
add_fileset_file i_syncbuf_m_sync_buffer_matvec_mult0.vhd VHDL PATH kernel_hdl/matvec_mult/i_syncbuf_m_sync_buffer_matvec_mult0.vhd TOP_LEVEL_FILE
add_fileset_file i_syncbuf_result_sync_buffer_matvec_mult4.vhd VHDL PATH kernel_hdl/matvec_mult/i_syncbuf_result_sync_buffer_matvec_mult4.vhd TOP_LEVEL_FILE
add_fileset_file matvec_mult_B0_branch.vhd VHDL PATH kernel_hdl/matvec_mult/matvec_mult_B0_branch.vhd TOP_LEVEL_FILE
add_fileset_file matvec_mult_B0_merge.vhd VHDL PATH kernel_hdl/matvec_mult/matvec_mult_B0_merge.vhd TOP_LEVEL_FILE
add_fileset_file matvec_mult_function_cra_slave.vhd VHDL PATH kernel_hdl/matvec_mult/matvec_mult_function_cra_slave.vhd TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL matvec_mult_system
add_fileset_file acl_shift_register.v SYSTEM_VERILOG PATH $::env(INTELFPGAOCLSDKROOT)/ip/acl_shift_register.v TOP_LEVEL_FILE
add_fileset_file acl_work_group_dispatcher.v SYSTEM_VERILOG PATH $::env(INTELFPGAOCLSDKROOT)/ip/acl_work_group_dispatcher.v TOP_LEVEL_FILE
add_fileset_file acl_kernel_finish_detector.v SYSTEM_VERILOG PATH $::env(INTELFPGAOCLSDKROOT)/ip/acl_kernel_finish_detector.v TOP_LEVEL_FILE
add_fileset_file acl_multistage_accumulator.v SYSTEM_VERILOG PATH $::env(INTELFPGAOCLSDKROOT)/ip/acl_multistage_accumulator.v TOP_LEVEL_FILE
